        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="../view/AtualizarVeiculo.php">Atualizar Veiculo</a></li>
                    <li class="nav-item"><a class="nav-link" href="../view/RemoverVeiculo.php">Remover Veiculo</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-heading">
                    <h2>Preencha os campos para atualizar o veículo</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="breadcrumb-content text-center">
                    <div class="breadcrumb-post-content">
                        <h2 class="post-title">Atualização dos </h2>
                    </div>
                </div>
            </div>
        </div>
...
if ($resultado->num_rows > 0) {
							...
							<div class='row'>
								<div class='col-12'>
									...
									<div class='roberto-contact-form'>
										 <form action='AtualizarVeiculoDefinitivo.php' method='post'>
											<div class='row'>
												<div class='col-12 col-lg-6 wow fadeInUp' data-wow-delay='100ms'>
													ID: <input type='text' class='form-control mb-30' value = '" . $linha['id'] . "'  name='idVeiculo' readonly='true'><br>
												</div>
												<div clas s='col-12 col-lg-6 wow fadeInUp' data-wow-delay='100ms'>
													Logradouro<input type='text' class='form-control mb-30' value = '" . $linha['logradouro'] . "' name='logradouro' required><br>
												</div>
												<div class='col-12 col-lg-6 wow fadeInUp' data-wow-delay='100ms'>
													Número:<input type='text' class='form-control mb-30' value = '" . $linha['numero'] . "' name='numero' required><br>
												</div>
												<div class='col-12 col-lg-6 wow fadeInUp' data-wow-delay='100ms'>
													Bairro:<input type='text' class='form-control mb-30' value = '" . $linha['bairro'] . "' name='bairro' required><br>
												</div>
												<div class='col-12 col-lg-6 wow fadeInUp' data-wow-delay='100ms'>
													Aluguel:<input type='text' class='form-control mb-30' value = '" . $linha['aluguel'] . "' name='aluguel' required><br>
												</div>
    ...
    echo "<script>alert('Não existe veiculo com essa placa cadastrado')</script>";
}
?>
