        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="RemoverVeiculo.php">Remover Veiculo</a></li>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form action="..\controller\RemoverVeiculoDefinitivo.php" method="post">
                <div class="row">
                    <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                        <input type="text" class="form-control mb-30" placeholder="Entre com a placa" name="placa"><br>
                    </div>
                    <div class="contact-form">
                        <button type="submit" style="margin: 0 15px;" value="Enviar" class="filled-button">Enviar</button>
