    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a class="nav-link" href="ConsultarContrato.php">Consultar Contrato</a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="section-heading">
          <h2>Digite o ID do contrato que deseja buscar</h2>
        </div>
      </div>
    </div>
  </div>
          ...
          <form action="../controller/ConsultarContrato.php" method="post">
            <div class="row">
              <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                <input type="text" class="form-control mb-30" placeholder="ID do contrato" name="idContrato""><br>
              </div>
              <div class=" contact-form">
                <button type=" submit" style="margin: 0 15px;" class="filled-button">Consultar</button>
              </div>
          </form>
        </div>
      </div>
