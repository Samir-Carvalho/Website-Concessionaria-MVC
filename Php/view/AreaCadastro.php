    ...
    <div class="container">
      <div class="row">
        ...
        <div class="section-heading">
          <h2>Selecione a forma de cadastro que irá realizar !</h2>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="contact-form">
          <div class="row">
            ...
            <form action="CadastrarFuncionario.php" method="post">
              <button type="submit" style="margin: 0 15px;" class="filled-button">Funcionário</button>
            </form>
            <br>
            <form action="CadastrarCliente.php" method="post">
              <button type="submit" style="margin: 0 15px;" class="filled-button">Cliente</button>
            </form>
            <br>
            <form action="CadastrarProprietario.php" method="post">
              <button type="submit" style="margin: 0 15px;" class="filled-button">Proprietário</button>
            </form>
          </div>
        </div>
      </div>
