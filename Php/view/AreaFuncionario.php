      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link active" href="AreaFuncionario.php">Home
        ...
        <div class="col-12" style="text-align: center;width: 100%;">
          ...
          <div class="contact-form">
            <form action="CadastrarContrato.php" method="post">
              <button type="submit" style="margin: 0 15px;" class="filled-button">Cadastrar Contrato</button>
            </form>
            <br>
            <form action="ConsultarContrato.php" method="post">
              <button type="submit" style="margin: 0 15px;" class="filled-button">Consultar Contrato</button>
            </form>
            <br>
            <form action="AtualizarContrato.php" method="post">
              <button type="submit" style="margin: 0 15px;" class="filled-button">Atualizar Contrato</button>
            </form>
            <br>
            <form action="RemoverContrato.php" method="post">
              <button type="submit" style="margin: 0 15px;" class="filled-button">Remover Contrato</button>
            </form>
          </div>
        </div>
      </div>
