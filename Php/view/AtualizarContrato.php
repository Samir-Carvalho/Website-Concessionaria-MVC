        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a class="nav-link" href="AtualizarContrato.php">Atualizar Contrato</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-heading">
                    <h2>Digite o ID do contrato que deseja atualisar</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <form action="../controller/AtualizarContrato.php" method="post">
                <div class="row">
                    ...
                    <div class=" contact-form">
                        <button type="submit" style="margin: 0 15px;" class="filled-button">Atualizar</button>
